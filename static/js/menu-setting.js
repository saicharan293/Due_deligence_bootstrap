    ...
    $('body').append('' +
        '<div id="styleSelector" class="menu-styler">' +
            ...
            '<div class="style-block">' +
                ...
                '<a href="http://ableproadmin.com/doc-7.0/"  class="btn btn-primary btn-block m-r-15 m-t-5 m-b-10 ">Online Documentation</a>' +
                '<div class="text-center">' +
                    '<span class="text-center f-18 m-t-15 m-b-15 d-block">Thank you for sharing !</span>' +
                    '<a href="https://www.facebook.com/Phoenixcoded/"  class="btn text-white bg-facebook btn-icon m-b-20">' +
                        '<i class="feather icon-facebook"></i>' +
                    '</a>' +
                    '<a href="https://twitter.com/phoenixcoded"  class="btn text-white bg-twitter btn-icon m-l-20 m-b-20">' +
